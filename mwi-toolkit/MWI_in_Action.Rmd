...
review_captions <- c(
  "1. Go to the MWI tool, select \"Maryland\" from the drop-down menu, and select \"Start Exploring!\"",
...
explore_captions <- c(
  "1. On the right hand-side they see their community has an overall Mental Wellness Index score of 22, a low score compared to the rest of the nation.",
