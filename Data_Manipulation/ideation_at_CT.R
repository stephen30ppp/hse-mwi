...
temp <- tempfile()
download.file(
  "https://www.samhsa.gov/data/sites/default/files/cbhsq-reports/NSDUHsubstateRegionDefs2016B/substate_definitions_SAS.zip",
  temp
)
...
ideation_county <- left_join(raw_county, raw_ideations,
  ...
  select(-c(
    "state", "aggflg16", "sbsta16n", "sbst16", "sbstag16",
...
write.csv(NSDUH_CT_suicideideation,
  file = file.path(
    data_folder,
